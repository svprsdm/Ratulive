...
export default class GiftAnimation extends React.Component {
    state = {
        hearts: [],
        hearts1: []
    };
        ...
        return (
            <View style={styles.container}>
                ...
                <TouchableOpacity onPress={this.addHeart}>
                    <Animated.Image style={{ width: 50, height: 50 }} source={require('../../../assets/icons/like1.png')} />
                </TouchableOpacity>
            </View>
        );
    }
